...
<script type="text/javascript">
	...
	/* window.onload = function(){
		...
		var options =categoryObj.getElementsByTagName("option");
	...
	$(function(){
		$("#category option[value='${pro.category}']").attr("selected",true);
	});
	
</script>
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath }/modifyProduct" method="post">
		<!-- 隐藏域 存储该商品的id -->
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="name" class="bg" value="${pro.name }" /></td>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="price" class="bg" value="${pro.price }" /></td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
				<td class="ta_01" bgColor="#ffffff">
					<input type="text" name="pnum" class="bg"  value="${pro.pnum }"/></td>
			...
			<TR>
				...
				<TD class="ta_01" bgColor="#ffffff" colSpan="3">
					<textarea name="description" cols="30" rows="3" style="WIDTH: 96%" >${pro.description }</textarea>
				</TD>
			</TR>
			<TR>
